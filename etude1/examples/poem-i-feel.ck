...
["fine", "joy", "excited", "inspired", "included", "understood", "artful", "playful", "free",
 "myself", "grateful", "optimistic"] @=> string positives[];

// starter "i feel" emotion words with negative connotations
["sad", "bored", "meh", "spent", "worried", "afraid", "marginalized", "misunderstood", "powerless",
 "undone", "small", "guilt", "cringe", "dread"] @=> string negatives[];

// starter "i feel" emotion words with other connotations
["numb", "nothing", "weird", "meh", "disjointed", "scattered", "complicated", "sus"] @=> string others[];
...
left => DelayL DL => left;
.5 => DL.gain;
T_WORD * 1.5 => DL.max => DL.delay;
right => DelayL DR => right;
.3 => DR.gain;
T_WORD * 2 => DR.max => DR.delay;
...
// sonify
fun void play(int pitch) { play(pitch, Math.random2f(.8, 1)); }
